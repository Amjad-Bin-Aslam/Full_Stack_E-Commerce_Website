...
function Add({token}) {
  ...
  return (
    <form className='flex flex-col items-start gap-3 w-full' onSubmit={onSubmitHandler}>
      ...
      <div>
        ...
        <input className='w-full px-3 py-2 sm:-[120px]' type="Number" placeholder='25' onChange={(e)=>setPrice(e.target.value)} value={price}/>
      </div>
